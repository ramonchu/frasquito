...
class MongoConnectionRepository implements ConnectionRepository {
	...
	public MongoConnectionRepository(String userId, ConnectionService connectionService,
	...
	public Connection<?> getConnection(ConnectionKey connectionKey) {
		try {
			return connService.getConnection(userId, connectionKey.getProviderId(), connectionKey.getProviderUserId());
